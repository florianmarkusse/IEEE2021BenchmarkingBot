...
def qq_plotting(first_distribution, second_distribution, first_label, second_label, title):
    plt.figure()
    qq_plot(first_distribution, second_distribution, edgecolor='k')
    ...
    max_value = max(max(first_distribution), max(second_distribution))
